...
ломать и ставить, на процедурной карте 4000×4000 метров — плюс механики Rust: добыча,
...
- **Кубический мир**: блоки 1×1×1 м, деревья и валуны из блоков, жилы руды в камне,
  вода. Блоки ломаются (прочность: трава 0.6 с, камень 2.2 с, руда 3 с) и ставятся
  обратно. Правки мира сохраняются, рельеф и декор считаются от сида —
  подробности и оптимизации в [docs/VOXELS.md](docs/VOXELS.md).
...
- **Инвентарь на 30 слотов** (6×5) с поясом быстрого доступа и стаками до 1000, крафт
  списком с прокруткой, главное меню с живым фоном, компас с курсом в градусах, карта во
  весь экран с приближением, координатной сеткой A1/B2 и стрелкой направления, настройки
  (качество, дальность прорисовки, потолок кадров, звук, чувствительность) и редактор
  раскладки сенсорных кнопок.
