...
- **Инвентарь на 30 слотов** (6×5) с поясом быстрого доступа и стаками до 1000, базовый
  крафт (доски, каменный блок, металл, сера, ткань), окно настроек и редактор раскладки
  сенсорных кнопок.
