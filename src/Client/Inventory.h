...
enum class ItemType : uint8_t {
    ...
    Cupboard,   // шкаф: в него платят аренду за дом
    Box,        // ящик: хранилище ресурсов
    Grenade,    // граната: бросается, взрывается, сносит постройки и игроков
    Hammer,     // киянка: сносит свои постройки без шкафа и улучшает их до камня и железа
    Revolver,      // револьвер: дальний бой по игрокам
    RevolverAmmo,  // патроны к револьверу
    Launcher,   // ракетница: ей рейдят чужие дома
    Rocket,     // ракета к ракетнице
    COUNT
};
