...
public:
    ...
    void resetLayout();
    // Раскладка одной строкой: её игрок копирует и присылает, чтобы такие координаты
    // стали значениями по умолчанию.
    std::string layoutAsText() const;          // вернуть стандартные позиции
