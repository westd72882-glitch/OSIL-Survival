...
void main(){
    ...
    // Дневное небо светлее и чище: прежний зенит уходил в тёмно-синий, и полдень
    // выглядел пасмурным вечером.
    vec3 dayZenith   = vec3(0.24, 0.50, 0.88);
    vec3 dayHorizon  = vec3(0.80, 0.89, 0.97);
